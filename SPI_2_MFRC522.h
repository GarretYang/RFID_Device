/******************************************************************************/
/*
  file    SPI_2_MFRC522.h
  
  communication and protocols for MFRC522
*/
/******************************************************************************/
...
int commandTag(unsigned char command, unsigned char *data, int dlen, unsigned char *result, int *rlen);
int requestTag(unsigned char mode, unsigned char *type);
...
int readFromTag(unsigned char blockAddr, unsigned char *recvData);
int writeToTag(unsigned char blockAddr, unsigned char *writeData);
int haltTag();
