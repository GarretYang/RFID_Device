...
#include "semphr.h"
#include "SSD2119.h"
//#include "touch_task.c"
//#include "traffic_task.c"
#include "blink_task.c"
#include "input_task.c"
#include "output_task.c"
...
//********************************RFID Initialization*********************************  
  ...
  SPI1_Init(); //initialize SPI2 for:
  //PD0 = SCK, PD1 = NSS (SDA), PD2 = MISO, PD3 = MOSI
