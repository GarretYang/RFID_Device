...
extern void Timer0InterruptIsr( void );
extern void Uart2InterruptIsr( void );
extern void Uart3InterruptIsr( void );
...
const intvec_elem __vector_table[] =
{
  ...
  0,         				 // Interupt  17
  0,
  Timer0InterruptIsr,                   // interrupt 19
  0,
  0,
  0,
  0,
  ...
  0,
  0,
  Uart2InterruptIsr, 		        // interrupt 33
  0,
  0,
  0,
  0,
  ...
  0,
  0,
  Uart3InterruptIsr, 		        // interrupt 59 
  0				        // interrupt 60  
};
...
#pragma call_graph_root = "interrupt"
__weak void Timer0InterruptIsr( void ) { while (1) {} }
#pragma call_graph_root = "interrupt"
__weak void Uart2InterruptIsr( void ) { while (1) {} }
#pragma call_graph_root = "interrupt"
__weak void Uart3InterruptIsr( void ) { while (1) {} }
